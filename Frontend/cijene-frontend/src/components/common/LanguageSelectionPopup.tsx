                ...
                <div className="p-8 text-center">
                    ...
                    <div className="space-y-3">
                        <button
                            ...
                            className="w-full py-3.5 px-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-blue-500/30 flex items-center justify-center gap-2 group"
                        >
                            <span>{t('popup.english')}</span>
                            <span className="text-blue-200 text-sm font-normal group-hover:text-white transition-colors">(Default)</span>
                        </button>
