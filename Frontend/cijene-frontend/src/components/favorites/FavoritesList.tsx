        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex flex-col gap-2 ml-4">
            <Button
              ...
              className="text-red-500 hover:text-red-600 p-1 h-8 w-8"
            ...
            <Link 
              ...
              className="text-blue-500 hover:text-blue-600 p-1 h-8 w-8 flex items-center justify-center"
      ...
      <Card className="p-4 hover:shadow-md transition-shadow">
        <div className="flex items-start justify-between">
          ...
          <div className="flex flex-col gap-2 ml-4">
            ...
            <Link 
              to={`/stores?search=${encodeURIComponent(store.name || '')}`}
              className="text-blue-500 hover:text-blue-600 p-1 h-8 w-8 flex items-center justify-center"
    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {items.map((item, index) => (
          <FavoriteItem
            key={type === 'products' ? (item as Product).ean || (item as Product).id || index : (item as StoreType).id || index}
            item={item}
            type={type}
