    ...
    <div className="flex-1">
      <div className="relative">
        ...
        <input
          ...
          className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${ean && !isValidEan(ean) ? 'border-red-300' : 'border-gray-300'
            }`}
        />
      </div>
      {ean && !isValidEan(ean) && (
