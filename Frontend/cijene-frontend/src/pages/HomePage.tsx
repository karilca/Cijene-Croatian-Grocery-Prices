      ...
      <div className="text-center py-8 sm:py-12 lg:py-16">
        ...
        <div className="max-w-2xl mx-auto mb-6 sm:mb-8 px-4 sm:px-0">
          <div className="relative">
            <input
              ...
              className="w-full px-4 sm:px-6 py-3 sm:py-4 text-base sm:text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-20 sm:pr-24"
              onKeyDown={(e) => {
                if (e.key === 'Enter') {
            ...
            />
            <button
              className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-blue-600 text-white px-3 sm:px-6 py-2 rounded-lg hover:bg-blue-700 touch-manipulation transition-colors duration-200 text-sm sm:text-base"
              onClick={(e) => {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
            <h3 className="text-xl sm:text-2xl font-bold text-blue-600 mb-2">10,000+</h3>
