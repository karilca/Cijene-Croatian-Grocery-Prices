...
export const StoresPage: React.FC = () => {
  ...
  const perPage = searchResponse?.per_page || 20;
    ...
    <div className="max-w-6xl mx-auto">
      ...
      {!(searchParams.query || searchParams.city || searchParams.latitude) && (
        <div className="bg-white rounded-lg shadow-md p-12 text-center">
          <StoreIcon className="h-16 w-16 text-blue-600 mx-auto mb-6" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            ...
            <div className="p-4 border border-gray-200 rounded-lg">
              <StoreIcon className="h-8 w-8 text-blue-600 mx-auto mb-3" />
            ...
            {import.meta.env.VITE_BETA_FEATURES === 'true' && (
              <div className="p-4 border border-gray-200 rounded-lg">
                <div className="h-8 w-8 bg-blue-600 rounded-full mx-auto mb-3 flex items-center justify-center">
