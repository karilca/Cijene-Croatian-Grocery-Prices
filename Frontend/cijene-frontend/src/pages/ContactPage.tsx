  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800">
      <header className="mb-8">
        <p className="text-sm uppercase tracking-wide text-blue-600">{t('contact.support')}</p>
      ...
      <section className="space-y-6 leading-relaxed">
        <div>
          ...
          <p>
            {t('contact.email.general')} <a className="text-blue-600 hover:underline" href="mailto:kolak@karlok.eu">kolak@karlok.eu</a>
            <br />{t('contact.email.support')} <a className="text-blue-600 hover:underline" href="mailto:kolak@karlok.eu">kolak@karlok.eu</a>
          </p>
        </div>
        <div>
